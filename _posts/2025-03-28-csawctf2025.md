...
date: 2025-03-28 14:48 +0100
last_modified_at: 2025-03-28 14:48 +0100
categories: [ctf]
tag : [forensics]
image: /assets/ctf/csawctf2025/logo.jpg
---

csaw ctf qualification round 2025, three (3) forensics writeups out of five (5)
...
<a href="/assets/zip/csawctf2025/challenge.zip" class="btn btn-primary" download>
...
its an image, loading it reveals the flag

![alt text](../assets/ctf/csawctf2025/final_result.png)
...
<a href="/assets/zip/csawctf2025/images.zip" class="btn btn-primary" download>
...
checking the first ones metadata reveals hidden information
...
its vigeneres encryption, cyberchef to the rescue

![alt text](../assets/ctf/csawctf2025/images0.png)
...
<a href="/assets/zip/csawctf2025/covert.zip" class="btn btn-primary" download>
