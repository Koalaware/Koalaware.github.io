...
date: 2025-10-04 14:33 +0100
last_modified_at: 2025-10-04 14:33 +0100
categories: [ctf]
tag : [forensics]
image: /assets/ctf/buckeyectf2025/logo.png
---
...
<a href="/assets/zip/buckeyectf2025/unknown.zip" class="btn btn-primary" download>
...
```
once this tar files contents are extracted we get the flag
```
...
<a href="/assets/zip/buckeyectf2025/dump.wav" class="btn btn-primary" download>
...
![alt text](../assets/ctf/buckeyectf2025/couch0.png)
...
<a href="/assets/zip/buckeyectf2025/dump" class="btn btn-primary" download>
...
![alt text](../assets/ctf/buckeyectf2025/dump0.png)

we get the start markers offset as well as the end markers offset

![alt text](../assets/ctf/buckeyectf2025/dump1.png)

we copy and paste in between content to a newly created hexdump and save as jpg file

![alt text](../assets/ctf/buckeyectf2025/dump2.png)

opening the file shows the flag

![alt text](../assets/ctf/buckeyectf2025/dump3.png)
...
<a href="/assets/zip/buckeyectf2025/capture.pcapng" class="btn btn-primary" download>
...
![alt text](../assets/ctf/buckeyectf2025/usb0.png)
...
<a href="/assets/zip/buckeyectf2025/dogs_wearing_tools.zip" class="btn btn-primary" download>
  <i class="fas fa-download"></i> dogs_wearing_tools.zip
</a>

<a href="/assets/zip/buckeyectf2025/important_flags.7z" class="btn btn-primary" download>
...
```
then, we procedd by cracking the zips keys
```
...
<a href="/assets/zip/buckeyectf2025/protected-cia-document.pdf" class="btn btn-primary" download>
...
```
we got b895821f14 as cracked hash password. we now open the pdf using qpdf. it is also possible to use 10420 mode of hashcat to crack this hash plains password, but this is more direct
```
...
![alt text](../assets/ctf/buckeyectf2025/pdf0.png)

cyberchef is always handy in these situations

![alt text](../assets/ctf/buckeyectf2025/pdf1.png)
