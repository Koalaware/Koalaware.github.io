---
layout: post
title: TCP1P CTF 2026
date: 2026-03-08 13:55 +0100
last_modified_at: 2026-03-08 13:55 +0100
categories: [ctf]
tag : [forensics]
image: /assets/ctf/tcp1pctf2026/logo.png
---

tcp1p ctf 2026 - exploring nusantaras digital realm
...
<SNIP>
```
looks obfuscated, but its running a powershell script. downloading it retrieves the following
```powershell
...
```
again an obfuscated payload but its clear what it does, it encrypts several files using aes schema, the following powershell script was used to decrypt both of the text file and the zip file
```powershell
function hLBKckxyHxqsbnKPcxuEltxXJgGMBEdtenTXDbrjJ {
    param (
        [byte[]]$fILecontEnt,
...
![alt text](../assets/ctf/tcp1pctf2026/sus2.png)

hence, unlocking the zip using the password and reading the flag

![alt text](../assets/ctf/tcp1pctf2026/sus3.png)
...
![alt text](../assets/ctf/tcp1pctf2026/skib1.png)
...
![alt text](../assets/ctf/tcp1pctf2026/skib0.png)
...
![alt text](../assets/ctf/tcp1pctf2026/dox0.png)
...
![alt text](../assets/ctf/tcp1pctf2026/dox1.png)

it points to a docker image

![alt text](../assets/ctf/tcp1pctf2026/dox2.png)
...
![alt text](../assets/ctf/tcp1pctf2026/dox3.png)
...
![alt text](../assets/ctf/tcp1pctf2026/hg0.png)
...
![alt text](../assets/ctf/tcp1pctf2026/enc0.png)
